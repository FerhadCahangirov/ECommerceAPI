...
namespace ECommerceAPI.Persistence.Services
{
    public class AuthorizationEndpointService : IAuthorizationEndpointService
    {
        ...
        public async Task AssignRoleEndpointsAsync(string[] roles, string menu, string code, Type type)
        {
            ...
            Endpoint? endpoint = await _endpointReadRepository.Table.Include(e => e.Menu).FirstOrDefaultAsync(e => e.Code == code);
        ...
        public async Task<List<string>> GetRolesToEndpointAsync(string code, string menu)
        {
            ...
            return endpoint != null ? endpoint.Roles.Select(r => r.Name).ToList() : null;
