...
namespace ECommerceAPI.Infrastructure.Services.Strorages.Azure
{
    public class AzureStorage : Storage, IAzureStorage
    {
        ...
        public AzureStorage(IConfiguration configuration) => _blobServiceClient = new(configuration["Storage:Azure"]);
